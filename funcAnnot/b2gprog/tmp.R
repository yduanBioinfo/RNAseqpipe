...
print("B")
head(summary(MF_over))
head(summary(MF_under))
head(summary(BP_over))
...
head(gostatall)
print("gostatall,increasing")
head(gostatall[order(gostatall$adj_pval,decreasing=F),])
print("I")
#plot
library(GOplot)

#sort zero genes to the last line
mysub = subset(gostatall,Pvalue<0.05)
print("I1")
