...
cat $1 | awk 'BEGIN{expfile="'$2'";annotfile="'$3'";mapfile="'$4'";prefix="'$prefix'"}/^ko/{system("echo "$1 "|/home/yduan/script/python/RNAseqpip/funcAnnot/kegg/map_NOIout_pip/map2ko.py "mapfile"| /home/yduan/script/python/RNAseqpip/funcAnnot/kegg/map_NOIout_pip/ko2gene.py "annotfile"| /home/yduan/script/python/RNAseqpip/funcAnnot/kegg/map_NOIout_pip/gene2annot.py "expfile"|"prefix"/heatmap.R "$1)}'
